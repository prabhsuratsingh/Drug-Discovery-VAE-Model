...
from model.VAE import MolecularVAE
...
def fingerprint_to_smiles(fp_array):
    ...
    # Find the closest molecule in the dataset
    ...
    return best_match['smiles']  # Return the closest known SMILES
...
def analyze_molecule(smiles):
    ...
    if mol:
        ...
        num_rings = Chem.rdMolDescriptors.CalcNumRings(mol)  # Number of Rings
        num_rot_bonds = Chem.rdMolDescriptors.CalcNumRotatableBonds(mol)  # Flexibility
